...
export const EmailTemplates = {
  verification: `
    <div style=" padding: 1rem 2rem;">
      <h3 style="font-size: 1.2rem; color: rgba(0,0,0, 0.8);">Confirmación de creación de cuenta</h3>
      <p style="font-size: 14px;">Gracias por crear una cuenta en Partiaf. Inicia sesión y descubre todas las opciones que tenemos para ti.</p>
    </div>
  `,
