    ...
    <div className={styles.body}>
      ...
      <div className={styles.main}>
        <form onSubmit={onSubmit}>
          ...
          <Input onChange={handleCheckBox} variant="checkbox" type="checkbox">
            <p className={styles.copy}>Recuerdame</p>
          </Input>
          <div className={styles.buttons}>
            ...
            <p>
              <Link className={styles.terms} to="">
                Olvide mi contraseña
              </Link>
            </p>
            <p className={styles.copy}>
              ¿No tienes cuenta?
              <Link className={styles.terms} to="/signup">
                {" "}
                Registrate
              </Link>
            </p>
