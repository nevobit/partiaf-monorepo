  ...
  return (
    <div className={styles.container_tic}>
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                {selectedEvent.eventName == "Soonoro Fest General"
                  ? selectedEvent.attendees
                  : 0}
              </p>
              <button
                onClick={() =>
                  handleIncrementAttendees(
                    "Soonoro Fest General",
                    50000,
                    "General"
                  )
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                {selectedEvent.eventName == "Partiaf Refest General"
                  ? selectedEvent.attendees
                  : 0}
              </p>
              <button
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                {selectedEvent.eventName == "Soonoro Fest Palco"
                  ? selectedEvent.attendees
                  : 0}
              </p>
              <button
      ...
      <div className={styles.btn_ye}>
        <button onClick={nextLocation}>Continuar</button>
      </div>
    </div>
  );
};
